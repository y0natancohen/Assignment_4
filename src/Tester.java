        ...
        do {
            ...
            for(char ch='a';flag&&ch<='z';ch++){
                for(char cha='a';flag&&cha<='z';cha++){
                    if(!testBTree.search(""+ch+cha)){           //assuming your search function returning null if it can't find the item, remove "== null" if its boolean function
            ...
            for(char ch='a';flag&&ch<='z';ch++){
                for(char c='a';flag&&c<='z';c++){
                    if(testBTree.search(""+ch+c+" ")){          //assuming your search function returning null if it can't find the item, remove "!= null" and add "!" if its boolean function
